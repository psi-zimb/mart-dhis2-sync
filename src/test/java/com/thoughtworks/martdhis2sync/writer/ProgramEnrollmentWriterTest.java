...
//
//        requestBody = "{\"enrollments\":[" + enrollments1.toString() + "," + enrollments2.toString() + "]}";
//
...
//        when(syncRepository.sendData(uri, requestBody, false)).thenReturn(responseEntity);
//
//        enrollmentsList.add(new Enrollment(referenceUIDs.get(0), instanceIDs.get(0), programName, "",  "2018-09-14", "2018-09-14", "ACTIVE", 1));
//        enrollmentsList.add(new Enrollment(referenceUIDs.get(1), instanceIDs.get(1), programName, "",  "2018-09-14", "2018-09-14", "ACTIVE", 2));
////        when(EnrollmentUtil.getNewOrUpdatedEnrollmentsList()).thenReturn(enrollmentsList);
//
//        writer.write(list);
//
//        verify(syncRepository, times(1)).sendData(uri, requestBody, false);
...
//
//        enrollmentsList.add(new Enrollment(EMPTY_STRING, instanceIDs.get(0), programName, "", new Date(), new Date(), "ACTIVE", 1));
//        enrollmentsList.add(new Enrollment(EMPTY_STRING, instanceIDs.get(1), programName, "", new Date(), new Date(), "ACTIVE", 2));
////        when(EnrollmentUtil.getNewOrUpdatedEnrollmentsList()).thenReturn(enrollmentsList);
//
//        writer.write(list);
//
...
//
//        enrollmentsList.add(new Enrollment(EMPTY_STRING, instanceIDs.get(0), programName, "", "2018-09-14", "2018-09-14", "ACTIVE", 1));
//        enrollmentsList.add(new Enrollment(EMPTY_STRING, instanceIDs.get(1), programName, "", "2018-09-14", "2018-09-14", "ACTIVE", 2));
////        when(EnrollmentUtil.getNewOrUpdatedEnrollmentsList()).thenReturn(enrollmentsList);
//
//        try {
//            writer.write(list);
...
//        when(syncRepository.sendData(uri, requestBody, false)).thenThrow(new HttpServerErrorException(HttpStatus.INTERNAL_SERVER_ERROR));
//
//        try {
//            writer.write(list);
//        } catch (Exception e) {
...
//        when(response.getImportSummaries()).thenReturn(importSummaries);
//
//        enrollmentsList.add(new Enrollment(referenceUIDs.get(0), instanceIDs.get(0), programName, "", new Date(), new Date(), "ACTIVE", 1));
//        enrollmentsList.add(new Enrollment(referenceUIDs.get(1), instanceIDs.get(1), programName, "", new Date(), new Date(), "ACTIVE", 2));
////        when(EnrollmentUtil.getNewOrUpdatedEnrollmentsList()).thenReturn(enrollmentsList);
//
//        try {
//            writer.write(list);
