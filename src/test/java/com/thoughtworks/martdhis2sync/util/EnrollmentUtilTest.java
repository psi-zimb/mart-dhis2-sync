...
public class EnrollmentUtilTest {
    ...
    @Test
    public void shouldUpdateCancelledEnrollmentDateWhenTheGivenDateIsGreater() throws Exception {
        EnrollmentUtil.updatedCancelledDate = new Date(Long.MIN_VALUE);
        String givenDate = "2018-10-28 12:00:03";

        EnrollmentUtil.updateLatestEnrollmentDateCreated(givenDate,  MarkerUtil.CATEGORY_UPDATED_CANCELLED_ENROLLMENT);

        assertEquals(givenDate, BatchUtil.getStringFromDate(EnrollmentUtil.updatedCancelledDate, BatchUtil.DATEFORMAT_WITH_24HR_TIME));
    }
    ...
    @Test
    public void shouldNotUpdateCancelledEnrollmentDateWhenTheGivenDateIsLesser() throws Exception {
        String actualDate = "2018-11-12 12:10:10";
        EnrollmentUtil.updatedCancelledDate = BatchUtil.getDateFromString(actualDate, BatchUtil.DATEFORMAT_WITH_24HR_TIME);
        String givenDate = "2018-10-28 12:00:03";

        EnrollmentUtil.updateLatestEnrollmentDateCreated(givenDate, MarkerUtil.CATEGORY_UPDATED_CANCELLED_ENROLLMENT);

        assertEquals(actualDate, BatchUtil.getStringFromDate(EnrollmentUtil.updatedCancelledDate, BatchUtil.DATEFORMAT_WITH_24HR_TIME));
    }
